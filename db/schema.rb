...
ActiveRecord::Schema.define(version: 20171023164426) do
  ...
  create_table "schedule_statuses", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["schedule_id"], name: "index_schedule_statuses_on_schedule_id", using: :btree
    t.index ["service_id"], name: "index_schedule_statuses_on_service_id", using: :btree
  end
  ...
  add_foreign_key "schedule_statuses", "schedules"
  add_foreign_key "schedule_statuses", "services"
